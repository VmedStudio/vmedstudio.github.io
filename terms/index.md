...
**By Using AI Artwork, you agree to these Terms. If you do not agree to these Terms, do not Use AI Artwork. Your continued Use of AI Artwork will confirm your acceptance of these Terms.**
...
**BY USING THE APPLICATION, YOU AFFIRM THAT YOU ARE OF LEGAL AGE TO ENTER INTO THE TERMS.** If you have any questions about these Terms or AI Artwork, please contact us via an email _vmedstudio@gmail.com_ (for additional contact information, please, see Section 13 of these Terms “How to Contact Us”).
...
## 7. FEEDBACK
We welcome any your feedback, questions, comments, suggestions, ideas, original or creative materials or other information you submit about us or AI Artwork (collectively, “**Feedback**”). For additional contact details please see Section 13 of these Terms “How to Contact Us”) or via reviews in Google Play. Your Feedback is non-confidential and will become our sole property once submitted to us. We will own exclusive rights, including, without limitation, all intellectual property rights, in and to your Feedback and will be entitled to the unrestricted use and dissemination of your Feedback for any purpose, commercial or otherwise, without acknowledgment or compensation to you. You also have the right to amend and supplement your Feedback to us, which we will take into account to provide accurate information to other users about AI Artwork’s user experience. If we decide to make your Feedback public, we will not use any of your personal data, unless you explicitly consent to it.


## 8. INDEMNIFICATION
To the fullest extent permitted by applicable law, you will indemnify, defend, and hold harmless us and each of our respective officers, directors, agents, partners and employees (individually and collectively, “**Company Parties**”) from and against any loss, liability, claim, demand, damages, expenses or costs (“Claims”) arising out of or related to (i) your Use of AI Artwork; (ii) your User Content or Feedback; (iii) your violation of these Terms; (iv) your violation, misappropriation or infringement of any rights of another (including intellectual property rights or privacy rights); and (v) your conduct in connection with AI Artwork. You agree to promptly notify the Company Parties of any third party Claims, cooperate with the Company Parties in defending such Claims and pay all fees, costs and expenses associated with defending such Claims (including, but not limited to, attorneys’ fees). You also agree that the Company Parties will have control of the defense or settlement of any third party Claims. This indemnity is in addition to, and not in lieu of, any other indemnities set forth in a written agreement between you and us or the other Company Parties.
...
The total liability of the Company and the other Company Parties, for any claim arising out of or relating to these Terms or AI Artwork, regardless of the form of the action, is limited to the amount paid, if any, by you to Use AI Artwork.
...
We may make changes to these Terms from time to time. If we make changes, we will post the amended Terms and update the “Effective date” above. In case we make substantial changes to the Terms (including the changes which might affect your rights), we will always notify you via in-app consent, email, or any other means of communication we may deem fit. If you do not agree to the amended terms, you must stop Using AI Artwork. Your continued Use of AI Artwork after we provide the notice will imply your acceptance of those changes.


## 12. TERMINATION
We reserve the right, without notice and in our sole discretion, to terminate your right to Use AI Artwork. We are not responsible for any loss or harm related to your inability to Use AI Artwork. Upon any termination, discontinuation or cancellation of AI Artwork, all provisions of these Terms, which by their nature should survive, will survive, including without limitation, ownership provisions, warranty disclaimers, limitations of liability and dispute resolution provisions.
...
Century Tower, Times city, 458 Minh Khai

Hai Ba Trung District, Hanoi, Vietnam


## 14. MISCELLANEOUS
 - These Terms constitute the entire agreement between you and us relating to AI Artwork and your Use of AI Artwork, and these Terms supersede and replace any and all prior oral or written understandings or agreements between the Company and you relating to AI Artwork and your Use of AI Artwork.
